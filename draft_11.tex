...
%%%%% FIGURE %%%%% FIGURE %%%%% FIGURE %%%%% FIGURE %%%%% 
\begin{figure*}[tbph]
\includegraphics[width=0.9\textwidth]{ZhiyuPictures/stationary_and_rotating_frame_t_1-5_5T.pdf}
%
...
%%%%% FIGURE %%%%% FIGURE %%%%% FIGURE %%%%% FIGURE %%%%% 
\begin{figure*}[tbph]
\includegraphics[width=0.9\textwidth]{ZhiyuPictures/rotating_frame_t_0-80T.pdf}  
...
\bibitem{Peeters_shell} V.~M.~Bedanov and and F.~M.~Peeters, ``Ordering and phase transitions of
