...
In cold atom experiment, when BEC happens, atoms condense into their groud state. If one suddenly modify the trap potential or interaction parameter, which is just a ``quench", then the low lying collective modes will be excited. One of the most consipicuous collective phenomenon is the breathing mode. Breathing mode, also called as monopole mode, is periodic expanding and contracting behaviour of the cloud of atoms. The frequency of breathing mode is widely discussed in literature. When the atoms have interaction, it is observed that the frequncy is dependent on the interaction. xxx used mean-field technique to calculate the relation between breathing frequency and interaction[ ]. While xxx numerically calculated the frequency[ ]... BEC is a quantum gas, so the existing literature on breathing modes all focus on quantum gas. But the quantum property is not necessary to the breathing mode phenomenon, though the question of breathing mode generate from BEC. For classical gas, there is also such breathing behaviour. So a natural question would be asked is, how do the breathing frequency of classical gas dependent on interaction or other parameters. Surprisingly, to the best of our knowledge this question is not answered yet in the literature and thus need study.

Moreover, in a nonquilibrium many-body system, a more intriguing question is about its thermalization or relaxation property. Thermalization is among the most fundamental process for a many-body interacting system. All systems do not thermalize. An example is the Fermi–Pasta–Ulam paradox [ ] where shows confinement in phase-space so that the system stay non-thermalized for a long time. A lot of research on thermalization property has been done in other classical system. H De Raedt, et al. studied the one dimensional gravitational system with Lyapunov exponents[ ]. xxx studied the ring of harmonic oscillators and magnetic moment by examine the canonical distribution of a subsystem[ ].

In this paper, we answer these two questions. In the first part, we give an estimation of breathing, along with its explanation, and compare that with the numerical simulation result. We will also show a rotating frame method of treating this problem, which is a convenient tool to analyze simple harmonic systems. In the second part, we study the thermalization property. We first examine the canonical disribution of energy to find out the threshold of thermalization, i.e. under what parameter the thermalization time scale is very large. Then we point out that there are two kind of thermalization (or relaxation) behaviour that could be measured in this system. In the end we measure the Lyapunov Exponent to quantify the time scales and confirm the former discussion.
...
\begin{figure}[hbtp]
\centering
\includegraphics[scale=0.6]{D:/matlab2016/MolecularDynamics/figure/latexpic/N=5_GS_pre_2.eps}
...
\includegraphics[scale=0.2]{D:/matlab2016/MolecularDynamics/figure/latexpic/stationary_frame_t=1-5T.eps} 
\includegraphics[scale=0.2]{D:/matlab2016/MolecularDynamics/figure/latexpic/rotating_frame_t=1-5T.eps}
\end{minipage}
}
\subfigure[$t=\frac{1}{5}T$]{
\begin{minipage}[b]{0.18\linewidth}
\includegraphics[scale=0.2]{D:/matlab2016/MolecularDynamics/figure/latexpic/stationary_frame_t=2-5T.eps} 
\includegraphics[scale=0.2]{D:/matlab2016/MolecularDynamics/figure/latexpic/rotating_frame_t=2-5T.eps}
\end{minipage}
}\subfigure[$t=\frac{2}{5}T$]{
\begin{minipage}[b]{0.18\linewidth}
\includegraphics[scale=0.2]{D:/matlab2016/MolecularDynamics/figure/latexpic/stationary_frame_t=3-5T.eps} 
\includegraphics[scale=0.2]{D:/matlab2016/MolecularDynamics/figure/latexpic/rotating_frame_t=3-5T.eps}
\end{minipage}
}\subfigure[$t=\frac{3}{5}T$]{
\begin{minipage}[b]{0.18\linewidth}
\includegraphics[scale=0.2]{D:/matlab2016/MolecularDynamics/figure/latexpic/stationary_frame_t=4-5T.eps} 
\includegraphics[scale=0.2]{D:/matlab2016/MolecularDynamics/figure/latexpic/rotating_frame_t=4-5T.eps}
\end{minipage}
}\subfigure[$t=\frac{4}{5}T$]{
\begin{minipage}[b]{0.18\linewidth}
\includegraphics[scale=0.2]{D:/matlab2016/MolecularDynamics/figure/latexpic/stationary_frame_t=5-5T.eps} 
\includegraphics[scale=0.2]{D:/matlab2016/MolecularDynamics/figure/latexpic/rotating_frame_t=5-5T.eps}
\end{minipage}
}
\caption{N=50,F0=100,E=50000}
\end{figure*}


\begin{figure*}
\includegraphics[scale=0.2]{D:/matlab2016/MolecularDynamics/figure/latexpic/10_18rotating_frame_t=10T.eps} 
\includegraphics[scale=0.2]{D:/matlab2016/MolecularDynamics/figure/latexpic/10_18rotating_frame_t=30T.eps}
\includegraphics[scale=0.2]{D:/matlab2016/MolecularDynamics/figure/latexpic/10_18rotating_frame_t=50T.eps} 
\includegraphics[scale=0.2]{D:/matlab2016/MolecularDynamics/figure/latexpic/10_18rotating_frame_t=70T.eps}
\includegraphics[scale=0.2]{D:/matlab2016/MolecularDynamics/figure/latexpic/10_18rotating_frame_t=90T.eps} 
...
\begin{figure}
\includegraphics[scale=0.6]{D:/matlab2016/MolecularDynamics/figure/latexpic/10_19trajectory_in_rotating_frame_t=130T_pre.eps}
...
\includegraphics[scale=0.5]{D:/matlab2016/MolecularDynamics/figure/latexpic/N=5_energydistribution_pre.eps} 
\includegraphics[scale=0.5]{D:/matlab2016/MolecularDynamics/figure/latexpic/N=10_energydistribution_pre.eps} 
\includegraphics[scale=0.5]{D:/matlab2016/MolecularDynamics/figure/latexpic/N=20_energydistribution_pre.eps}
...
\includegraphics[scale=0.5]{D:/matlab2016/MolecularDynamics/figure/latexpic/11_1_boltzmann_N=10_F=10000_pre.eps}
\caption{Energy distribution, N=10, F0=10000}
\label{fig:thermalization9}

\includegraphics[scale=0.5]{D:/matlab2016/MolecularDynamics/figure/latexpic/11_1_boltzmann_N=20_F=10000_pre.eps} 
...
\begin{figure}[hbtp]
\centering
\includegraphics[scale=0.5]{D:/matlab2016/MolecularDynamics/figure/latexpic/freq_spectrum_N=10_E=1000_pre.eps}
...
\begin{figure}[hbtp]
\centering
\includegraphics[scale=0.4]{D:/matlab2016/MolecularDynamics/figure/latexpic/LLEdistribution_scanE_9_27_pre_screenshot.png}
...
\bibliography{E:/Reference/mybib}
