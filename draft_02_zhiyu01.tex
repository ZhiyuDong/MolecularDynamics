...
exponent. %With these approaches, we will show that the thermalization time scale manifest a
...
\caption{dependence of breathing frequency on Energy, N=20. Different color stands for different $F_0$: Red for $F_0$=2000; Yellow for $F_0$=3000; Green for $F_0$=10000;  Blue for $F_0$=100000. Run with 3 different initial states in each case, and in each run, measure the frequency in 0-100 time unit(label as crosses) and in 900-1000 time unit (label as circles). The black dashed line is the prediction of Eq.\ref{eq:breathingfrequency1}.}
...
\begin{figure}
\includegraphics[width=0.5\textwidth]{ZhiyuPictures/N=10_single_particle_energy_F0=200_Font12_s.eps} 
\caption{energy of each particle, $F_0=200$}
\label{fig:thermalization6}

\includegraphics[width=0.5\textwidth]{ZhiyuPictures/N=10_single_particle_energy_F0=1000_Font12_s.eps} 
